                ...
                <div class="pt-20 flex justify-between flex-wrap gap-4">
                    ...
                    <div class="flex gap-3">
                        ...
                        <a href="{{ route('serviceenquiry', $service->id) }}"
                            class="px-6 py-5 rounded-xl bg-primary text-white font-semibold">
                            Send Enquiry
                        </a>
    ...
    <section class="max-w-7xl mx-auto px-4 mt-8">
        ...
        <div class="bg-white rounded-3xl p-8">
            ...
            <div class="grid lg:grid-cols-2 gap-10">
                ...
                {{-- IMAGE --}}
                @php
                    $serviceImagesArr = json_decode($service->service_img, true);
                    $mainImage = !empty($serviceImagesArr[0]) ? $serviceImagesArr[0] : null;
                @endphp

                <div>
                    @if ($mainImage)
                        <img src="{{ asset('uploads/service/images/' . $mainImage) }}"
