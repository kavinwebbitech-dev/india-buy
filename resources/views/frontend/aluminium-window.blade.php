            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-header-box">
                        <h1 class="text-anime-style-3" data-cursor="-opaque">Aluminium Windows</h1>
                        <nav class="wow fadeInUp">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('home')}}">home |</a></li>
                                <li class="breadcrumb-item"><a href="{{route('gallery')}}">Doors |</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Aluminium Windows</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="project-single-content">
                        <div class="page-single-image">
                            <figure class="image-anime reveal">
                                <img src="{{ asset('asset/frontend/new/alu-win.webp')}}" alt="Sherene uPVC Doors">
                            </figure>
                        </div>

                        <div class="project-entry">
                            <p class="wow fadeInUp">
                                Sherene Aluminium Windows are trusted across Tamil Nadu for their strength, sleek design, and long-lasting performance. With over 2,00,000 installations, our windows are designed to enhance modern homes and commercial spaces while delivering superior structural efficiency.
                            </p>
                            <p class="wow fadeInUp" data-wow-delay="0.2s">
                                Our aluminium windows offer smooth operation, excellent ventilation, weather resistance, and low maintenance, making them ideal for residential and commercial projects.
                            </p>

                            <div class="project-overview-box">
                                <h2 class="text-anime-style-3">Aluminium Windows Overview</h2>
                                <p class="wow fadeInUp">
                                    Sherene provides premium aluminium windows engineered for structural strength, sound insulation, thermal efficiency, and durability. Each window system combines modern aesthetics with high-performance functionality.
                                </p>

                                <div class="project-overview-body">
                                    <div class="project-overview-image">
                                        <figure class="image-anime reveal">
                                            <img src="{{ asset('asset/frontend/new/alu-win-1.webp')}}" alt="Premium uPVC Doors">
                                        </figure>
                                    </div>
                                    ...
                                    <div class="project-overview-item-box wow fadeInUp" data-wow-delay="0.2s">
                                        <div class="project-overview-item">
                                            ...
                                            <div class="project-overview-item-content">
                                                <h3>Premium Aluminium Windows</h3>
                                                <p>
                                                    Precision Window Systems

                                                    Designed for smooth operation, safety, and long-term performance, our aluminium windows ensure comfort and peace of mind.
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="project-overview-list-contact-box">
                                            <div class="project-overview-list">
                                                <ul>
                                                    <li>Aluminium Casement Windows</li>
                                                    <li>Aluminium Sliding Windows</li>
                                                    <li>Aluminium Fixed Windows</li>
                                                    <li>Aluminium Glass-to-Glass Corner Windows</li>
                                                    <li>Aluminium French Windows</li>
                                                    <li>Aluminium Tilt & Turn Windows</li>
                                                </ul>
                                            </div>
                                        ...
                                        <div class="project-item-image">
                                            <a href="javascript:void(0)" data-cursor-text="view">
                                                <figure class="image-anime">
                                                    <img src="{{ asset('asset/frontend/new/alu-cas-win.webp')}}" alt="Two-panel Sliding Door">
                                                </figure>
                                            </a>
                                        </div>
                                        <div class="project-item-content">
                                            <h3><a class="text-white" href="javascript:void(0)">Aluminium Casement Windows</a></h3>
                                            <ul>
                                ...
                                <div class="col-xl-4 col-md-6 my-4">
                                    <div class="project-item wow fadeInUp" data-wow-delay="0.2s">
                                        <div class="project-item-image">
                                            <a href="javascript:void(0)" data-cursor-text="view">
                                                <figure class="image-anime">
                                                    <img src="{{ asset('asset/frontend/new/alu-sli-win.webp')}}" alt="Three-panel Sliding Door">
                                                </figure>
                                            </a>
                                        </div>
                                        <div class="project-item-content">
                                            <h3><a class="text-white" href="javascript:void(0)">Aluminium Sliding Windows</a></h3>
                                            <ul>
                                ...
                                <div class="col-xl-4 col-md-6 my-4">
                                    <div class="project-item wow fadeInUp" data-wow-delay="0.4s">
                                        <div class="project-item-image">
                                            <a href="javascript:void(0)" data-cursor-text="view">
                                                <figure class="image-anime">
                                                    <img src="{{ asset('asset/frontend/new/alu-fix-win.webp')}}" alt="Four-panel Sliding Door">
                                                </figure>
                                            </a>
                                        </div>
                                        <div class="project-item-content">
                                            <h3><a class="text-white" href="javascript:void(0)">Aluminium Fixed Windows</a></h3>
                                            <ul>
                                ...
                                <div class="col-xl-4 col-md-6 my-4">
                                    <div class="project-item wow fadeInUp" data-wow-delay="0.6s">
                                        <div class="project-item-image">
                                            <a href="javascript:void(0)" data-cursor-text="view">
                                                <figure class="image-anime">
                                                    <img src="{{ asset('asset/frontend/new/alu-gls-wi.webp')}}" alt="Sliding Door with Bug Mesh">
                                                </figure>
                                            </a>
                                        </div>
                                        <div class="project-item-content">
                                            <h3><a class="text-white" href="javascript:void(0)">Aluminium Glass-to-Glass Corner Windows</a></h3>
                                            <ul>
                                ...
                                <div class="col-xl-4 col-md-6 my-4">
                                    <div class="project-item wow fadeInUp" data-wow-delay="0.8s">
                                        <div class="project-item-image">
                                            <a href="javascript:void(0)" data-cursor-text="view">
                                                <figure class="image-anime">
                                                    <img src="{{ asset('asset/frontend/new/alu-fnc-win.webp')}}" alt="Casement Door">
                                                </figure>
                                            </a>
                                        </div>
                                        <div class="project-item-content">
                                            <h3><a class="text-white" href="javascript:void(0)">Aluminium French Windows</a></h3>
                                            <ul>
                                ...
                                <div class="col-xl-4 col-md-6 my-4">
                                    <div class="project-item wow fadeInUp" data-wow-delay="1s">
                                        <div class="project-item-image">
                                            <a href="javascript:void(0)" data-cursor-text="view">
                                                <figure class="image-anime">
                                                    <img src="{{ asset('asset/frontend/new/alu-tilt-win.webp')}}" alt="Bi-Fold Door">
                                                </figure>
                                            </a>
                                        </div>
                                        <div class="project-item-content">
                                            <h3><a class="text-white" href="javascript:void(0)">Aluminium Tilt & Turn Windows</a></h3>
                                            <ul>
                                                <li>Premium Residences</li>
                                            </ul>
                                        </div>
