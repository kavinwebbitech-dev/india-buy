...
<div class="bg-white rounded-2xl border border-gray-100 p-2 mb-8 flex items-center gap-2 overflow-x-auto shadow-sm">
    ...
    <a href="{{ route('service.dashboard') }}"
        ...
        {{ request()->routeIs('service.dashboard')
    ...
    {{-- PRODUCTS --}}
    <a href="{{ route('service.product.list') }}"
        class="px-5 py-2.5 rounded-xl text-[14px] font-medium whitespace-nowrap
        {{ request()->routeIs('service.product.*')
            ? 'bg-primary text-white'
            : 'text-gray-500 hover:bg-slate-50' }}">
    ...
    {{-- PROFILE --}}
    <a href="{{ route('service.profile') }}"
        class="px-5 py-2.5 rounded-xl text-[14px] font-medium whitespace-nowrap
        {{ request()->routeIs('service.profile') || request()->routeIs('service.profile.update')
            ? 'bg-primary text-white'
            : 'text-gray-500 hover:bg-slate-50' }}">
