...
<header class="bg-white sticky top-0 z-50 shadow-sm font-sans relative">
    ...
    {{-- <div id="mobileSidebarOverlay" class="fixed inset-0 bg-black/60 z-[9998] hidden opacity-0 transition-opacity duration-300"></div>

    <div id="mobileSidebar" class="fixed top-0 left-0 h-full w-[280px] bg-white z-[9999] transform -translate-x-full transition-transform duration-300 shadow-2xl flex flex-col overflow-y-auto">
        ...
        <div class="flex flex-col py-2 px-4 gap-1">
            <a href="{{ route('home') }}" class="flex items-center gap-3 py-3 text-gray-700 hover:text-primary font-medium border-b border-gray-50">
                <i data-lucide="home" class="w-5 h-5 text-gray-400"></i> Home
            </a>
             <a href="{{ route('home') }}" class="flex items-center gap-3 py-3 text-gray-700 hover:text-primary font-medium border-b border-gray-50">
                <i data-lucide="package" class="w-5 h-5 text-gray-400"></i> Categories
            </a>
            <a href="{{ route('products') }}" class="flex items-center gap-3 py-3 text-gray-700 hover:text-primary font-medium border-b border-gray-50">
                <i data-lucide="package" class="w-5 h-5 text-gray-400"></i> Products
            </a>
            <a href="{{ route('sevice_list') }}" class="flex items-center gap-3 py-3 text-gray-700 hover:text-primary font-medium border-b border-gray-50">
                <i data-lucide="briefcase" class="w-5 h-5 text-gray-400"></i> Services
            </a>
            <a href="{{ route('postrfq') }}" class="flex items-center gap-3 py-3 text-gray-700 hover:text-primary font-medium border-b border-gray-50">
            ...
            @if (!$user)
                <a href="{{ route('register') }}" class="flex items-center justify-center gap-2 bg-primary text-white py-3 rounded-xl font-bold mt-2 hover:bg-red-600 transition-colors">
                    <i data-lucide="user-plus" class="w-4 h-4"></i> Register / Login
                </a>
            </else>
                <a href="{{ route('user.dashboard') }}" class="flex items-center gap-3 py-3 text-gray-700 hover:text-primary font-medium border-b border-gray-50">
                ...
                <form action="{{ route('logout') }}" method="POST" class="mt-2">
                    @csrf
                    <button type="submit" class="flex w-full items-center justify-center gap-2 bg-red-50 text-red-600 py-3 rounded-xl font-bold hover:bg-red-100 transition-colors">
                        <i data-lucide="log-out" class="w-4 h-4"></i> Logout
                    </button>
                </form>
            @endif
