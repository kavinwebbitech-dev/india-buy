...
@section('page-title', 'Edit Banner Plan')
...
<div class="main py-4">
    ...
    <div class="card border-0 shadow-sm rounded-4 bg-white overflow-hidden">
        ...
        <div class="card-header bg-white border-bottom border-light py-4 px-4 d-flex justify-content-between align-items-center">
            <div>
                <h4 class="fw-bold text-dark mb-1" style="letter-spacing: -0.5px;">Edit Banner Plan</h4>
                <p class="text-muted small mb-0">Modify pricing, duration configurations, and display limits for this vendor banner plan.</p>
            </div>
        ...
        <div class="card-body p-4">
            <form id="bannerPlanForm" action="{{ route('admin.bannerplans.update', $data->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="plan_name" class="form-control bg-light-focus border-start-0 rounded-end-3 py-2.5 placeholder-muted" 
                                   value="{{ $data->plan_name }}" placeholder="e.g. Premium Sidebar Pack">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="price" class="form-control bg-light-focus border-start-0 rounded-end-3 py-2.5 placeholder-muted" 
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="duration" class="form-control bg-light-focus border-start-0 rounded-end-3 py-2.5 placeholder-muted" 
                                   value="{{ $data->duration }}" placeholder="30">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="max_banners" class="form-control bg-light-focus border-start-0 rounded-end-3 py-2.5" 
                                   value="{{ $data->max_banners }}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea name="description" class="form-control bg-light-focus rounded-3 py-2.5 placeholder-muted" rows="3" 
                                  placeholder="Describe the perks, location visibility...決">{{ $data->description }}</textarea>
                    </div>
                ...
                <div class="mt-5 pt-3 border-top border-light d-flex justify-content-end gap-2">
                    <button type="button" onclick="window.location.reload();" class="btn btn-light px-4 py-2.5 rounded-3 fw-semibold text-muted small">
                        Discard Edits
                    </button>
                    <button type="submit" class="btn btn-dark px-4 py-2.5 rounded-3 fw-semibold small shadow-sm hover-lift">
                        <i class="fa fa-check-circle me-2"></i> Update Plan Config
                    </button>
                </div>
